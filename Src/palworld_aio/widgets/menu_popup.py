...
class nf:
    icons = {'nf-md-file': '📁', 'nf-md-function': '⚙️', 'nf-md-map': '🗺️', 'nf-md-playlist_remove': '🚫', 'nf-md-translate': '🌐', 'nf-md-chevron_right': '▶️'}
from i18n import t
try:
    ...
    def refresh_labels(self):
        ...
        for category, btn in self.menu_buttons.items():
            if category in labels:
                try:
                    icon = nf.icons.get({'file': 'nf-md-file', 'functions': 'nf-md-function', 'maps': 'nf-md-map', 'exclusions': 'nf-md-playlist_remove', 'languages': 'nf-md-translate'}.get(category, ''), '')
                except:
                    icon = ''
                chevron = '▶'
