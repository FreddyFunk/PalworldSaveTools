...
setup(name='PalworldSaveTools', version="1.1.65", options={'build_exe': build_exe_options}, executables=[Executable('src/palworld_aio/main.py', base='gui', target_name='PalworldSaveTools.exe', icon='resources/pal.ico')])