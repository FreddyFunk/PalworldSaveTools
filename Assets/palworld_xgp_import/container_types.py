...
from utils import read_u32 ,read_utf16_string ,read_u64 ,read_u8 ,NotSupportedError ,read_utf16_fixed_string ,write_u32 ,write_utf16_fixed_string ,write_utf16_string ,write_u8 ,write_u64 
class FILETIME :
