...
- Edit player pals with full stat editor
...
- Shows coordinates and guild information

### Pal Editor

Comprehensive pal editing interface:
- Edit stats: HP, Attack, Defense, Melee, Ranged, Armor
- Modify skills and passives
- Adjust IVs (talents)
- Change rank (stars)
- Set souls
- Toggle boss/lucky status
- Change gender
- Clone pals
